    ...
    return (
      <div className="relative w-full mb-8">
        <button
          ...
          className="absolute left-1/2 -translate-x-1/2 -translate-y-8 z-10 flex items-center justify-center w-8 h-8 rounded-full bg-white border border-gray-200 shadow-sm hover:bg-gray-50 transition-colors"
          aria-expanded={false}
